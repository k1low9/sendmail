...
def sendMail():
    ...
    # --- MODE: TEST or PROD ---
    MODE = "TEST"   # ← 本番時は "PROD" に変更
    print(f"=== 現在の送信モード: {MODE} ===")

    sender = "mail@localmaison.com"
    password = "fuyu-07070707"
...
******************************************
    ...
    host, port = "www2368.sakura.ne.jp", 587

    # --- 添付ファイル ---
    print("Current dir:", os.getcwd())
    files = glob.glob(os.path.join(os.getcwd(), "imgs", "*"))
    print("添付ファイル一覧:", files)
